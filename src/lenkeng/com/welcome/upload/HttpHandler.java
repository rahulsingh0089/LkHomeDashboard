...
public class HttpHandler<T> extends CompatibleAsyncTask<Object, Object, Void> implements RequestCallBackHandler {
    ...
    private ResponseInfo<T> sendRequest(HttpRequestBase request) throws HttpException {
    	Logger.e(TAG, "~~~~~~~~~执行请求,thread="+Thread.currentThread().getName());
    ...
    protected void onProgressUpdate(Object... values) {
    	Logger.e(TAG, "======== onProgressUpdate(),调用更新状态,Thread="+Thread.currentThread().getName());
    ...
    public boolean updateProgress(long total, long current, boolean forceUpdateUI) {
    	...
    	//Logger.e(TAG, "--------------updateProgress(),total="+total+",current="+current+",forceUpdateUI="+forceUpdateUI+",thread="+Thread.currentThread().getName());
